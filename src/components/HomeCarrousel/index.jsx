...
function HomeCarrousel() {
  ...
  const dataCarousel = [
    ...
    {image: "https://ovicio.com.br/wp-content/uploads/2022/12/20221207-ovicio-guardioes-galaxia-vol-3-poster.jpg", title: "Guardiões da Galáxia", sub: `"Ainda não se sabem muitos detalhes da trama, mas a conclusão da trilogia acompanha o grupo de heróis desajustados precisa salvar o universo novamente enquanto Peter Quill tenta se ajustar à ausência de Gamora. O grupo também deve enfrentar Adam Warlock, revelado em uma cena pós-crédito do segundo longa. "`},
